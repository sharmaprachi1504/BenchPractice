             ...
             if(env.AppDeploy == 'true'){
              bat '''
               cd C:\\Users\\prachisharma01\\Downloads\\BenchPractice
                ...
                scp -v -r -o StrictHostKeyChecking=no -i C:\\Users\\prachisharma01\\Downloads\\BenchPractice\\mynewkey.pub TestCalculatorAppJuly21Batch.war ubuntu@3.85.55.35:/tmp
